...
@section('content')
    <section id="data-guru" class="pt-5">
        <div class="container py-5">
            <div class="header-section text-center mb-5" data-aos="fade-up">
                <h1 class="fw-bold">Tenaga Kependidikan</h1>
                <p class="text-muted">Tenaga kependidikan SMP Al Husainiyah yang profesional dan berdedikasi</p>
                        ...
                        <div class="card border-0 shadow-sm">
                            <div class="card-body p-5 text-center text-muted">
                                ...
                                <p class="mb-0">Data tenaga kependidikan akan ditampilkan di sini setelah diisi
                                    melalui panel admin (Filament).</p>
                            </div>
                        </div>
                    </div>
                </div>
