                ...
                <div class="container py-5">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" name="subject"
                                                    class="form-control bg-light border-0 p-3 @error('subject') is-invalid @enderror"
                                                    value="{{ old('subject') }}" placeholder="Subjek pesan" required>
                                                @error('subject')
                                                    <div class="invalid-feedback small">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mb-4">
                                                ...
                                                <textarea name="message" class="form-control bg-light border-0 p-3 @error('message') is-invalid @enderror"
                                                    rows="5" placeholder="Tuliskan pesan atau pertanyaan Anda di sini..." required>{{ old('message') }}</textarea>
                                                @error('message')
                                                    <div class="invalid-feedback small">{{ $message }}</div>
                                                @enderror
                                            </div>
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            @if ($kontak && isset($kontak->location['lat']) && isset($kontak->location['lng']))
                                const lat = {{ $kontak->location['lat'] }};
                                const lng = {{ $kontak->location['lng'] }};
                            @else
