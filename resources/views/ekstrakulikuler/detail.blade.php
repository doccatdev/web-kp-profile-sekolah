    ...
    <section class="position-relative" style="margin-top: 76px;">
        <div class="w-100 overflow-hidden" style="min-height: 400px; max-height: 550px; height: 60vh; position: relative;">
            ...
            <img src="{{ asset('storage/' . $ekskul->thumbnail) }}"
                class="w-100 h-100 object-fit-cover position-absolute top-0 start-0" style="object-position: center;"
                ...
                <div class="col-lg-10">
                        ...
                        <div class="d-flex align-items-center gap-3 mb-4 pb-3 border-bottom">
                            ...
                            <div>
                                <small class="text-muted d-block fw-semibold text-uppercase"
                                    style="font-size: 0.75rem;">Guru Pembina</small>
                                <span class="fw-bold text-dark fs-5">{{ $ekskul->pembina }}</span>
                            </div>
                        </div>

                        <div class="text-secondary body-text"
                            style="line-height: 1.9; text-align: justify; font-size: 1.1rem; color: #4b5563;">
                    ...
                    @if ($ekskul->photos && $ekskul->photos->count() > 0)
                        <div class="galeri-section mt-5 pt-5 border-top">
                            <h4 class="fw-bold mb-4 text-center text-dark">Dokumentasi Kegiatan Ekstrakulikuler
                                {{ $ekskul->nama_ekskul }} </h4>
                            <div id="ekskulGallery" class="carousel slide shadow rounded-4 overflow-hidden"
                                        ...
                                        <div class="carousel-item {{ $key == 0 ? 'active' : '' }}" data-bs-interval="4000">
                                            ...
                                            @if ($photo->caption)
                                                <div class="carousel-caption d-block">
                                                    <div
                                                        class="d-inline-block bg-dark bg-opacity-50 px-4 py-1 rounded-pill">
                                ...
                                <button class="carousel-control-prev" type="button" data-bs-target="#ekskulGallery"
                                    data-bs-slide="prev">
                                    <span
                                        class="carousel-control-prev-icon bg-dark rounded-circle p-3 bg-opacity-50"></span>
                                </button>
                                <button class="carousel-control-next" type="button" data-bs-target="#ekskulGallery"
                                    data-bs-slide="next">
                                    <span
                                        class="carousel-control-next-icon bg-dark rounded-circle p-3 bg-opacity-50"></span>
                                </button>
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="text-center mt-5 pt-4">
                        <a href="{{ route('ekstrakulikuler.index') }}"
                            class="btn btn-success rounded-pill px-5 py-2 fw-bold transition-up">
