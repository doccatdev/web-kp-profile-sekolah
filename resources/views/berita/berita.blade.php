...
<section id="berita" style="margin-top: 100px;">
    <div class="container py-5">
        <div class="header-berita text-center mb-5" data-aos="fade-up">
            <h2 class="fw-bold display-6">Berita</h2>
            <p class="text-muted">Berita seputar SMP Al Husainiyah</p>
            <hr class="mx-auto">
        </div>
                ...
                <div class="sidebar-sticky">
                    <div class="card sidebar-category border-0 shadow-sm p-4">
                        ...
                        <div class="list-group list-group-flush">
                            <a href="{{ route('berita.index') }}" class="list-group-item list-group-item-action border-0 px-0 d-flex justify-content-between align-items-center {{ !request('kategori') ? 'text-danger fw-bold' : 'text-dark' }}">
