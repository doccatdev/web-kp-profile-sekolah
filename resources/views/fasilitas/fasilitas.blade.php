                    ...
                    <div class="col-md-6 col-lg-4" data-aos="fade-up">
                        <div class="card border-0 rounded-4 shadow-sm h-100 p-4">
                            <div class="bg-success bg-opacity-10 text-success rounded-3 d-inline-flex align-items-center justify-content-center mb-3" style="width:64px;height:64px;">
                                <i class="{{ $f->icon_class ?? 'bi bi-building' }} fs-3"></i>
                            </div>
                            <h4 class="fw-bold mb-3">{{ $f->nama_fasilitas }}</h4>
                            <p class="text-muted mb-4 flex-grow-1">{{ $f->deskripsi_singkat }}</p>
                            <a href="{{ route('fasilitas.detail', $f->slug) }}" class="btn btn-emerald w-100 rounded-pill mt-auto">
