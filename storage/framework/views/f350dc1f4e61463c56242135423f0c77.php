...
<body class="bg-light d-flex flex-column min-vh-100">
                            ...
                            <?php
                                ...
                                $config = [
                                    ...
                                    'App\Models\PpdbInfo' => [
                                        ...
                                        'title' => 'PPDB TA ' . ($item->tahun_ajaran ?? '') . ' Dibuka!',
                                        'link' => url('/ppdb')
                                    ],
                                    'App\Models\PengumumanSekolah' => [
                                        'type' => 'Pengumuman',
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Cek apakah carousel punya item aktif (untuk handle jika semua item di-skip)
            const hasActiveItem = document.querySelector('#toastCarousel .carousel-item');

            if (toast && hasActiveItem) {
                setTimeout(() => {
