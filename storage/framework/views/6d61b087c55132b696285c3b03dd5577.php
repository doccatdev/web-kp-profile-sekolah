<?php $__env->startSection('content'); ?>
    ...
    <section class="position-relative" style="margin-top: 76px;">
        <div class="position-relative w-100 overflow-hidden">
            ...
            <div class="ratio ratio-21x9 bg-dark d-flex align-items-center justify-content-center" style="min-height: 300px; max-height: 500px;">
                <img src="<?php echo e(asset('storage/' . $prestasi->thumbnail)); ?>"
                     class="w-100 h-100 object-fit-contain position-relative"
                     style="z-index: 2;"
                     alt="<?php echo e($prestasi->judul); ?>">

                
                <div class="position-absolute top-0 start-0 w-100 h-100"
                     style="background: url('<?php echo e(asset('storage/' . $prestasi->thumbnail)); ?>') center/cover no-repeat; filter: blur(15px) brightness(0.6); z-index: 1;">
                </div>
            </div>
        ...
        <div class="container text-start">
            ...
            <div class="d-flex align-items-center flex-wrap gap-2 gap-md-3 mb-4 pb-3 border-bottom border-light text-muted small">
                <div class="d-flex flex-wrap align-items-center gap-3" style="font-size: 0.9rem;">
                    <span class="d-inline-flex align-items-center">
                        ...
                        <span>Dipublikasikan: <?php echo e(\Carbon\Carbon::parse($prestasi->tanggal_posting)->format('d M Y')); ?></span>
                    </span>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($prestasi->photos && $prestasi->photos->count() > 0): ?>
                <div class="mt-5 pt-4 border-top border-light">
                    ...
                    <div id="prestasiGallery" class="carousel slide rounded-3 border border-light overflow-hidden mb-4 shadow-sm"
            ...
            <div class="carousel-item <?php echo e($index == 0 ? 'active' : ''); ?>" data-bs-interval="4000">
                ...
                <div class="position-relative d-flex align-items-center justify-content-center bg-dark"
                    ...
                    <img src="<?php echo e(asset('storage/' . $photo->foto)); ?>"
                         ...
                         alt="Galeri <?php echo e($prestasi->judul); ?>">

                    
                    <div class="position-absolute top-0 start-0 w-100 h-100"
                         style="background: url('<?php echo e(asset('storage/' . $photo->foto)); ?>') center/cover no-repeat; filter: blur(20px) brightness(0.7); z-index: 1;">
                    </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($photo->caption): ?>
                        <div class="carousel-caption d-block" style="z-index: 3;">
                            <div class="d-inline-block bg-dark bg-opacity-50 px-4 py-1 rounded-pill border border-light border-opacity-25">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($prestasi->photos->count() > 1): ?>
        <button class="carousel-control-prev" type="button" data-bs-target="#prestasiGallery" data-bs-slide="prev" style="z-index: 4;">
            <span class="carousel-control-prev-icon bg-dark rounded-circle p-3 bg-opacity-25" aria-hidden="true"></span>
        </button>
        <button class="carousel-control-next" type="button" data-bs-target="#prestasiGallery" data-bs-slide="next" style="z-index: 4;">
