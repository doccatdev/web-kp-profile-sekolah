    ...
    <section class="position-relative" style="margin-top: 76px;">
        <div class="w-100 overflow-hidden" style="height: 450px; position: relative;">
            ...
            <img src="<?php echo e(asset('assets/images/activity-01.jpg')); ?>"
                class="w-100 h-100 object-fit-cover position-absolute top-0 start-0" alt="<?php echo e($title ?? 'Detail Prestasi'); ?>">
            ...
            <div class="container position-relative h-100 d-flex flex-column justify-content-end pb-5" style="z-index: 2;">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-2">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('prestasi.index')); ?>"
            ...
            <div class="row">
                <div class="col-12">
                    <div class="bg-white p-0" data-aos="fade-up" data-aos-delay="100">
                        <div class="bg-white p-0">
                            <div class="konten-berita">
                                ...
                                <h2 class="fw-bold mb-3"><?php echo e($title ?? 'Detail Prestasi'); ?></h2>
                                ...
                                <div class="d-flex align-items-center flex-wrap mb-4 text-secondary"
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span>Dipublikasikan: <strong><?php echo e(date('Y')); ?></strong></span>
                                    </div>
                                ...
                                <div class="text-secondary body-text"
                                    ...
                                    <h5 class="fw-bold text-dark mt-4 mb-3">Galeri <?php echo e($title); ?></h5>
                    ...
                    <div class="text-center mt-5" data-aos="fade-up" data-aos-delay="200">
                        <a href="<?php echo e(route('prestasi.index')); ?>" class="btn btn-outline-dark rounded-pill px-4 py-2">
