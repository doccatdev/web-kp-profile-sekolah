        ...
        <div class="container-fluid p-0">
            <div class="card border-0 shadow-none">
                <div class="position-relative">
                    ...
                    <img src="<?php echo e(asset('storage/' . $item->thumbnail)); ?>" class="w-100 object-fit-cover" style="height: 500px;" alt="<?php echo e($item->nama_fasilitas); ?>">
                ...
                <div class="container py-5">
                    ...
                    <div class="gallery-section mt-5 pt-5 border-top">
                        <h3 class="fw-bold text-dark mb-4 text-center">Foto-Foto Fasilitas <?php echo e($item->nama_fasilitas); ?></h3>
                        <div id="fasilitasGallery" class="carousel slide shadow-sm" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item <?php echo e($key == 0 ? 'active' : ''); ?>">
                                    <img src="<?php echo e(asset('storage/' . $g->image)); ?>" class="d-block w-100 object-fit-cover" style="height: 550px;" alt="Gallery">
