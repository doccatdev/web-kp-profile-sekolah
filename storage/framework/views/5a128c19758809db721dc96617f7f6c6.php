            ...
            <div class="container position-relative h-100 d-flex flex-column justify-content-end pb-5" style="z-index: 2;">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-2">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('berita.index')); ?>"
                        ...
                        <div class="konten-berita">
                            ...
                            <div class="d-flex align-items-center flex-wrap mb-4 text-secondary bg-white py-3 border-bottom"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <span>Dipublikasikan:
                                        <strong><?php echo e($item->posted_at->locale('id')->translatedFormat('j F Y')); ?></strong></span>
                                </div>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->category): ?>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span>Kategori:
                                            <a href="<?php echo e(route('berita.index', ['category' => $item->category->slug])); ?>"
                                ...
                                <div class="card border border-light shadow-sm rounded-4 overflow-hidden">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-4" style="height: 100px;">
                                            <img src="<?php echo e(asset('assets/images/il-berita-0' . ($i > 3 ? 1 : $i) . '.png')); ?>"
                                        ...
                                        <div class="col-8">
                                            <div class="card-body p-3 bg-white">
                                                ...
                                                <div class="text-muted small">
                                                    ...
                                                    <?php echo e(date('d F Y', strtotime('-' . $i . ' days'))); ?>
