            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="konten-isi mb-5">
                        <div class="d-flex align-items-center gap-3 mb-4 pb-3 border-bottom">
                            ...
                            <div>
                                ...
                                <span class="fw-bold text-dark fs-5"><?php echo e($ekskul->pembina); ?></span>
                            </div>
                        </div>
                    ...
                    <div class="text-center mt-5 pt-4">
                        <a href="<?php echo e(route('ekstrakulikuler.index')); ?>" class="btn btn-success rounded-pill px-5 py-2 fw-bold transition-up">
