            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up">
                    <div class="card border-0 rounded-4 shadow-sm h-100 p-4 feature-card">
                        ...
                        <a href="<?php echo e(route('fasilitas.detail', ['id' => 'laboratorium-komputer'])); ?>"
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="card border-0 rounded-4 shadow-sm h-100 p-4 feature-card">
                        ...
                        <a href="<?php echo e(route('fasilitas.detail', ['id' => 'sarana-olahraga'])); ?>"
                            class="btn btn-emerald w-100 rounded-pill mt-auto">Lihat Detail <i
                                class="bi bi-arrow-right ms-1"></i></a>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="card border-0 rounded-4 shadow-sm h-100 p-4 feature-card">
                        ...
                        <a href="<?php echo e(route('fasilitas.detail', ['id' => 'masjid'])); ?>"
                            class="btn btn-emerald w-100 rounded-pill mt-auto">Lihat Detail <i
                                class="bi bi-arrow-right ms-1"></i></a>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up">
                    <div class="card border-0 rounded-4 shadow-sm h-100 p-4 feature-card">
                        ...
                        <a href="<?php echo e(route('fasilitas.detail', ['id' => 'alat-kesenian'])); ?>"
                            class="btn btn-emerald w-100 rounded-pill mt-auto">Lihat Detail <i
                                class="bi bi-arrow-right ms-1"></i></a>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="card border-0 rounded-4 shadow-sm h-100 p-4 feature-card">
                        ...
                        <a href="<?php echo e(route('fasilitas.detail', ['id' => 'ruang-belajar'])); ?>"
                            class="btn btn-emerald w-100 rounded-pill mt-auto">Lihat Detail <i
                                class="bi bi-arrow-right ms-1"></i></a>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="card border-0 rounded-4 shadow-sm h-100 p-4 feature-card">
                        ...
                        <a href="<?php echo e(route('fasilitas.detail', ['id' => 'ruang-serba-guna'])); ?>"
                            class="btn btn-emerald w-100 rounded-pill mt-auto">Lihat Detail <i
                                class="bi bi-arrow-right ms-1"></i></a>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up">
                    <div class="card border-0 rounded-4 shadow-sm h-100 p-4 feature-card">
                        ...
                        <a href="<?php echo e(route('fasilitas.detail', ['id' => 'perpustakaan'])); ?>"
                            class="btn btn-emerald w-100 rounded-pill mt-auto">Lihat Detail <i
                                class="bi bi-arrow-right ms-1"></i></a>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="card border-0 rounded-4 shadow-sm h-100 p-4 feature-card">
                        ...
                        <a href="<?php echo e(route('fasilitas.detail', ['id' => 'toilet-dan-wastafel'])); ?>"
                            class="btn btn-emerald w-100 rounded-pill mt-auto">Lihat Detail <i
                                class="bi bi-arrow-right ms-1"></i></a>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\belajar\laravel-website-sekolah\web-profile-sekolah\resources\views/fasliltas/fasilitas.blade.php ENDPATH**/ ?>