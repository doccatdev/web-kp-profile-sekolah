...
<?php $__env->startSection('content'); ?>
    ...
    <section class="position-relative" style="margin-top: 76px;">
        <div class="w-100 overflow-hidden" style="height: 400px; position: relative;">
            ...
            <img src="<?php echo e($program->image ? asset('storage/' . $program->image) : asset('assets/images/activity-02.jpg')); ?>"
                class="w-100 h-100 object-fit-cover position-absolute top-0 start-0" alt="<?php echo e($program->title); ?>">
            ...
            <div class="container position-relative h-100 d-flex flex-column justify-content-end pb-5" style="z-index: 2;">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-2">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(url('/program-unggulan')); ?>"
                ...
                <h1 class="fw-bold text-white display-4 mb-0" data-aos="fade-up"><?php echo e($program->title); ?></h1>
            </div>
        </div>
    </section>
